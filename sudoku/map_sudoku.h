...
public:
    ...
    void onlyOneColumn (bool& flag, bool& goOutOfLoop, size_t column, size_t row, size_t p); //checks if there is only one possible number to be put by the column
    void onlyOneRow(bool& flag, bool& goOutOfLoop, size_t column, size_t row, size_t p); //checks if there is only one possible number to be put by the row
    void onlyOneBox(bool& flag, bool& goOutOfLoop, size_t column, size_t row, size_t p); //checks if there is only one possible number to be put by the box
